...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-slate-200 bg-white/40 py-4 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/40">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 sm:flex-row">
        {/* Left Side: Brand Logo and Name */}
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="CarVault Logo" className="h-8 w-auto object-contain" />
